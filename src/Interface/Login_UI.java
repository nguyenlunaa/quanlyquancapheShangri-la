...
public class Login_UI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Coffe House");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, -1, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/coffee-6-128.png"))); // NOI18N
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 180, 140, 120));
    ...
    private void btn_loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_loginMouseClicked
        ...
        int lv = cn.LVTK(tk);
        boolean check = true;
        getSecurePassword(txtPassword.getText()).equals(getSecurePassword(tk2.GetPassword()));
        if(check == true){
